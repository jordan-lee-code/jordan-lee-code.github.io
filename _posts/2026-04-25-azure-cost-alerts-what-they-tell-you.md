...
Setting tags for cost attribution and using resource group cost breakdowns makes the investigation faster after the fact, but the alert itself contains none of that context when it arrives. The alert is, in effect, the smoke alarm going off in the hallway, and Cost Management is the room where you have to go to find out where the fire actually is.
...
The temptation, once you have the alerts configured, is to treat them as if they were a complete monitoring picture in their own right, and they are not. They are a partial picture and a starting point for the investigation that has to follow, and what they tell you is only that something has changed in your spend pattern. What changed, and whether the change was intentional, is work you still have to do for yourself, on top of whatever the alert told you.

The person on the receiving end of a cost alert at eleven at night cares less about the threshold the alert was tuned to than about whether the message in front of them gives them enough information to act on without having to dig further. That is the audience to design these alerts for: the engineer pulled out of her own evening at an unreasonable hour, sitting up in bed with her phone, trying to decide whether the thing is real, not a dashboard reviewer reading the same alert calmly in daylight the next morning. I am still thinking about how much of cost management, and how much of monitoring more generally, would feel kinder if we designed it for that one tired person rather than for the dashboard. I do not have a complete answer for it yet, but I wanted to leave the question here, because it is the question I keep returning to.
